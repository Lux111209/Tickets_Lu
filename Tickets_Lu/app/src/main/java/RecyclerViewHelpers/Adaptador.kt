...
import luz.gaspario.tickets_lu.R
...
class Adaptador(private var Datos: List<dataClassTickets>) : RecyclerView.Adapter<ViewHolder>() {
    ...
    fun eliminarDatos(titulo: String, UUID_Ticket: String, Posicion: Int){
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            val deleteTickets = objConexion?.prepareStatement("delete from Ticket where titulo = ? and UUID_Ticket = ?")!!
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        fun actualizarDato(UUID_Ticket: String, titulo: String, descripcion: String, autor: String, email: String, fecha: String) {
            GlobalScope.launch(Dispatchers.IO) {
                val objConexion = ClaseConexion().cadenaConexion()
